...
/*   Updated: 2021/11/20 17:20:02 by mdaillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Scavtrap::Scavtrap() : Claptrap("Mechantox le sanglant")
{
	...
	std::cout << "Constructor called --> " << this->_name << " is upgraded from Claptrap to Scavtrap ! He is now more powerfull ";
	std::cout << "than ever" << std::endl;
}
